        ...
        if (attack_duration <= 0)
        {
            ...
            switch (change)
            {
                case Change.ATTACK1:
                    ...
                    OnDamage(transform.GetChild(0).position,2f, 3f);
                    Sound.PlaySound("S_X_chop");
                    break;
                ...
                case Change.ATTACK2:
                    ...
                    OnDamage(transform.GetChild(0).position, 3f, 3.5f);
                    Sound.PlaySound("S_fullsight");
                    break;
                case Change.ATTACK3:
                    OnDamage(transform.GetChild(0).position, 4f, 5f);
                    player_Script.Shake(0.45f, 0.22f);
                    player_Script.rigidbody.AddForce(new Vector2(localScale.x * 3f, 5f), ForceMode2D.Impulse);
                    Instantiate(hitSfx3, transform.GetChild(0).position, Quaternion.identity);
                    OnDamage(transform.GetChild(0).position, 3f, 2.5f);
                    Sound.PlaySound("S_Thunder_rage");
                    break;
                case Change.ATTACK4:
